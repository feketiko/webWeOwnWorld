            ...
            <div id="page-wrapper">
                ...
                <section id="main">
                    <div class="container">
                        ...
                        <ul class="divided post">
                            <?php $solves = get_solve($solve);?>
                            <?php foreach ($solves as $solv): ?>
                            <li class="post">
                                <article>
                                    <header>
                                        <h3>
                                            <strong> <?=utf8_encode($solv['title'])?> </strong>

                                        </h3>
                                    </header>
                                    <p>
                                        <?=utf8_encode($solv['description'])?> </br>
                                        


                                    </p>
                                    <a href="#" class="image featured"><img src=<?=$solv[ 'img']?> alt="" /></a>
                                   
                                    <?=utf8_encode($solv['content'])?>
